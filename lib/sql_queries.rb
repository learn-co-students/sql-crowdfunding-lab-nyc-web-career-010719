...
def selects_the_titles_of_all_projects_and_their_pledge_amounts_alphabetized_by_name
  # "SELECT projects.title, SUM(pledges.amount) FROM projects JOIN pledges ON projects.id = pledges.project_id  ORDER BY projects.title, pledges.amount ASC "
...
# "SELECT users.name, users.age, pledges.amount FROM users JOIN pledges ON users.id = pledges.user_id ORDER BY users.name, users.age, pledges.amount ASC"
